...
\begin{scnindent}
    \scnrelfrom{пример входной конструкции}{\scnfileimage{images/direct_inference_input.png}}
    \begin{scnrelfromvector}{параметры агента}
        ...
        \begin{scnindent}
            ...
            \scnrelfrom{описание примера}{\scnfileimage{images/rule_example.png}}
        \end{scnindent}
    ...
    \scnrelfrom{пример выходной конструкции}{\scnfileimage{images/direct_inference_output.png}}
