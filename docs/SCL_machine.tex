        ...
        \begin{scnindent}
            ...
            \begin{scnrelfromvector}{параметры агента}
                ...
                \begin{scnindent}
                    ...
                    \begin{scnindent}
                        \scntext{пояснение}{В данном примере значением переменной \_x в шаблоне цели может быть sc-узел argument\_1, тогда значением \_y будет argument\_2
                        или наоборот: значением \_x sc-eузел argument\_2, а значением \_y -- argument\_1.}
                    \end{scnindent}
            ...
            \begin{scnrelfromvector}{обобщённый алгоритм}
                ...
                \scnfileitem{Построение вектора очереди правил на основе множества правил. Цикл по всем правилам и по не достигнута цель;}
                \begin{scnindent}
